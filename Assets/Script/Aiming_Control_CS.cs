    ...
    public class Aiming_Control_CS : MonoBehaviour
    {
        ...
        */
        ...
        public void Prepare()
        {
            ...
            Target_Position = transform.position + (transform.forward * 128.0f);
        }
        ...
        public void Get_Input()
        {
            ...
            Turret_Speed_Multiplier += 2.0f * Time.deltaTime;
            Turret_Speed_Multiplier = Mathf.Clamp01(Turret_Speed_Multiplier);
            ...
            { // Ngắm tự do.
                ...
                screenCenter.y = Screen.height * (0.5f + 0.2f);
                Cast_Ray_Free(screenCenter);
            }

            // Điều khiển "reticleAimingFlag" trong "Aiming_Control_CS".
            reticleAimingFlag = false;
        }
